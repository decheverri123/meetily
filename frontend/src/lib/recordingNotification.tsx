          ...
          <div className="space-y-3 min-w-[280px]">
            ...
            <label className="flex items-center gap-2 text-xs cursor-pointer hover:bg-primary/10 p-2 rounded transition-colors">
              <input
                ...
                className="rounded border-border/20 bg-secondary/10 text-primary focus:ring-primary focus:ring-2"
              />
            ...
            <button
              ...
              className="w-full px-3 py-1.5 bg-primary text-background text-xs rounded hover:bg-primary/90 transition-colors font-medium"
            >
