    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <select
          ...
          className="w-full px-3 py-2 text-sm text-foreground bg-secondary/5 border border-border/10 rounded-md focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary disabled:bg-secondary/10 disabled:text-muted-foreground [&>option]:bg-background [&>option]:text-foreground"
        >
        ...
        {isParakeet && (
          <div className="p-2 bg-amber-500/15 border border-amber-400/25 rounded text-amber-400">
