...
export default function AnalyticsDataModal({ isOpen, onClose, onConfirmDisable }: AnalyticsDataModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="glass-panel shadow-xl shadow-black/20 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        {/* Header */}
        ...
        <div className="p-6 space-y-6">
          {/* Privacy Notice */}
          <div className="bg-success/15 border border-success/25 rounded-lg p-4">
          ...
          <div className="space-y-4">
            ...
            {/* Model Preferences */}
            <div className="border border-border/10 bg-secondary/5 rounded-lg p-4">
          ...
          <div className="bg-destructive/15 border border-destructive/30 rounded-lg p-4">
            ...
            <ul className="text-sm text-destructive/90 space-y-1 ml-4">
          ...
          {/* Example Event */}
          <div className="bg-secondary/5 border border-border/10 rounded-lg p-4">
  ...
  "had_fatal_error": "false"
        ...
        {/* Footer */}
        <div className="flex items-center justify-between gap-4 p-6 border-t border-border/10 bg-secondary/5">
          <button
            onClick={onClose}
            className="px-4 py-2 text-foreground bg-secondary/5 border border-border/10 rounded-md hover:bg-secondary/10 transition-colors"
          >
            Keep Analytics Enabled
          </button>
          <button
            onClick={onConfirmDisable}
            className="px-4 py-2 text-destructive border border-destructive/40 bg-destructive/15 rounded-md hover:bg-destructive/25 transition-colors"
          >
