...
export function RecordingSettings({ onSave }: RecordingSettingsProps) {
  ...
  if (loading) {
    return (
      <div className="animate-pulse">
        <div className="h-4 bg-secondary/10 rounded w-1/4 mb-4"></div>
        <div className="h-8 bg-secondary/10 rounded mb-4"></div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-4 text-foreground">Recording Settings</h3>
      ...
      {preferences.auto_save && (
        <div className="space-y-4">
          <div className="p-4 border border-border/10 rounded-lg bg-secondary/5">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm text-foreground border border-border/10 rounded-md hover:bg-secondary/10 transition-colors"
            >
          ...
          <div className="p-4 border border-primary/20 rounded-lg bg-primary/10">
      ...
      {!preferences.auto_save && (
        <div className="p-4 border border-amber-400/25 rounded-lg bg-amber-500/15">
