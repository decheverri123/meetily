...
export function SummaryModelSettings({ refetchTrigger }: SummaryModelSettingsProps) {
  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className="glass-card p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-foreground/80">Auto Generating summary after meeting completion(Stopping)</p>
          </div>
      ...
      <div className="glass-card p-6">
        <h3 className="text-lg font-semibold mb-4 text-foreground">Summary Model Configuration</h3>
