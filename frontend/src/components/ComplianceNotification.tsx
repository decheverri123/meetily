...
export const ComplianceNotification: React.FC<ComplianceNotificationProps> = ({
  ...
  return (
    ...
    >
      <div className="glass-card shadow-lg shadow-black/20 p-3">
        ...
        <div className="flex items-start justify-between mb-2">
          ...
          <button
            onClick={handleClose}
            className="text-muted-foreground/60 hover:text-foreground/80 transition-colors p-0.5 rounded hover:bg-secondary/10"
          >
            <X className="h-3 w-3" />
          </button>
        </div>
        ...
        <div className="mb-2">
          ...
          <div className="bg-amber-500/15 border border-amber-500/20 rounded p-1">
        ...
        <div className="flex gap-1">
          ...
          <Button
            ...
            className="text-xs px-2 py-0.5 h-6 bg-success text-background hover:bg-success/90 flex-1"
          >
