        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-success/20 text-success rounded-lg hover:bg-success/30 disabled:bg-secondary/10 disabled:text-muted-foreground disabled:cursor-not-allowed transition-colors"
            >
              {isImporting ? (
                <>
            ...
            <button
              onClick={handleNo}
              disabled={isImporting}
              className="flex-1 px-4 py-2 border-2 border-primary/30 text-primary rounded-lg hover:bg-primary/10 disabled:bg-secondary/5 disabled:text-muted-foreground disabled:cursor-not-allowed transition-colors"
            >
              No, Browse Manually
            </button>
          </div>
