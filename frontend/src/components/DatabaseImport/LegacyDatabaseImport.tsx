        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-primary text-background rounded-lg hover:bg-primary/90 disabled:bg-secondary/10 disabled:text-muted-foreground disabled:cursor-not-allowed transition-colors"
            >
          ...
          {/* Detection Result */}
          {detectedPath && (
            <div className="p-3 bg-success/15 border border-success/20 rounded-lg">
          ...
          <div className="flex flex-col gap-3 pt-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-success/20 text-success rounded-lg hover:bg-success/30 disabled:bg-secondary/10 disabled:text-muted-foreground disabled:cursor-not-allowed transition-colors"
            >
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full px-4 py-3 border-2 border-border/15 text-foreground/80 rounded-lg hover:bg-secondary/10 disabled:bg-secondary/5 disabled:text-muted-foreground disabled:cursor-not-allowed transition-colors"
            >
