  ...
  return (
    <div className="max-w-md mb-4 space-y-3">
      ...
      {(!hasMicrophone || !hasSystemAudio) && (
        <Alert variant="destructive" className="glass-panel border-destructive/20 bg-destructive/10">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-foreground bg-secondary/10 border border-border/10 hover:bg-secondary/20 rounded-md transition-colors disabled:opacity-50"
            >
          ...
          <AlertDescription className="text-foreground/80 mt-2">
            ...
            {!hasMicrophone && (
              <>
                ...
                <div className="space-y-2 text-sm mb-4">
                  <p className="font-medium text-foreground">Please check:</p>
            ...
            {!hasSystemAudio && (
              <>
                ...
                {isMacOS && (
                  <div className="space-y-2 text-sm mb-4">
                    <p className="font-medium text-foreground">To enable system audio on macOS:</p>
                    <ul className="list-disc list-inside ml-2 space-y-1 text-muted-foreground">
