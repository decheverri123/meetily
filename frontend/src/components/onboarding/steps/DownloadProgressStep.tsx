        ...
        <div className="mt-2 p-3 bg-destructive/10 border border-destructive/20 rounded-md">
          ...
          {(title === 'Transcription Engine' || title === 'Summary Engine') && (
            <button
              ...
              className="mt-3 w-full h-9 px-4 bg-primary hover:bg-primary/90 text-background text-sm font-medium rounded-md transition-colors flex items-center justify-center gap-2"
            >
      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        <AnimatePresence>
          {parakeetDownloaded && !summaryModelDownloaded && (
            <motion.div
              ...
              className="w-full max-w-lg glass-card p-4 text-sm text-foreground"
            >
        ...
        <div className="w-full max-w-xs">
          <Button
            ...
            className="w-full h-11 disabled:cursor-not-allowed"
          >
