    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="text-center">
                ...
                <p className="text-medium text-foreground/80 mt-1">
            ...
            <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                    <div className="bg-secondary/5 border border-border/10 rounded p-3 hover:bg-secondary/10 transition-colors">
                        <h3 className="font-bold text-sm text-foreground mb-1">Privacy-first</h3>
                        <p className="text-xs text-foreground/80 leading-relaxed">Your data & AI processing workflow can now stay within your premise. No cloud, no leaks.</p>
                    </div>
                    <div className="bg-secondary/5 border border-border/10 rounded p-3 hover:bg-secondary/10 transition-colors">
                        <h3 className="font-bold text-sm text-foreground mb-1">Use Any Model</h3>
                        <p className="text-xs text-foreground/80 leading-relaxed">Prefer local open-source model? Great. Want to plug in an external API? Also fine. No lock-in.</p>
                    </div>
                    <div className="bg-secondary/5 border border-border/10 rounded p-3 hover:bg-secondary/10 transition-colors">
                        <h3 className="font-bold text-sm text-foreground mb-1">Cost-Smart</h3>
                        <p className="text-xs text-foreground/80 leading-relaxed">Avoid pay-per-minute bills by running models locally (or pay only for the calls you choose).</p>
                    </div>
                    <div className="bg-secondary/5 border border-border/10 rounded p-3 hover:bg-secondary/10 transition-colors">
                        <h3 className="font-bold text-sm text-foreground mb-1">Works everywhere</h3>
                        <p className="text-xs text-foreground/80 leading-relaxed">Google Meet, Zoom, Teams-online or offline.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="text-center space-y-2">
                ...
                <button
                    ...
                    className="inline-flex items-center px-4 py-2 bg-primary hover:bg-primary/90 text-background text-sm font-medium rounded transition-colors duration-200"
                >
