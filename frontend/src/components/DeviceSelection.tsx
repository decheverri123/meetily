    ...
    return (
      <div className="p-4 space-y-4">
        <div className="animate-pulse">
          <div className="h-4 bg-secondary/10 rounded w-1/3 mb-4"></div>
          <div className="h-10 bg-secondary/10 rounded mb-3"></div>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="h-8 w-8 p-0 inline-flex items-center justify-center rounded-md text-sm font-medium text-foreground/80 transition-colors hover:bg-secondary/10 hover:text-foreground disabled:pointer-events-none disabled:opacity-50"
          >
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          {showLevels && inputDevices.length > 0 && (
            <div className="space-y-2 pt-2 border-t border-border/10">
              <p className="text-xs text-foreground/80 font-medium">Microphone Levels:</p>
              {inputDevices.map((device) => {
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Speaker className="h-4 w-4 text-foreground/80" />
