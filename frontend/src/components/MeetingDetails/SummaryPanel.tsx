    ...
    <div className="flex-1 min-w-0 flex flex-col glass-panel overflow-hidden">
      ...
      {isSummaryLoading ? (
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          {summaryResponse && (
            <div className="fixed bottom-0 left-0 right-0 glass-panel shadow-lg shadow-black/20 p-4 max-h-1/3 overflow-y-auto">
              <h3 className="text-lg font-semibold mb-2 text-foreground">Meeting Summary</h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="glass-card p-4">
                  <h4 className="font-medium mb-1 text-foreground">Key Points</h4>
                  <ul className="list-disc pl-4">
                    {summaryResponse.summary.key_points.blocks.map((block, i) => (
                      <li key={i} className="text-sm text-foreground/80">{block.content}</li>
                    ))}
                  </ul>
                </div>
                <div className="glass-card p-4 mt-4">
                  <h4 className="font-medium mb-1 text-foreground">Action Items</h4>
                  <ul className="list-disc pl-4">
                ...
                <div className="glass-card p-4 mt-4">
                  <h4 className="font-medium mb-1 text-foreground">Decisions</h4>
                  <ul className="list-disc pl-4">
                ...
                <div className="glass-card p-4 mt-4">
                  <h4 className="font-medium mb-1 text-foreground">Main Topics</h4>
                  <ul className="list-disc pl-4">
              ...
              {summaryResponse.raw_summary ? (
                <div className="mt-4">
                  <h4 className="font-medium mb-1 text-foreground">Full Summary</h4>
                  <p className="text-sm whitespace-pre-wrap text-foreground/80">{summaryResponse.raw_summary}</p>
                </div>
              ) : null}
            </div>
          )}
