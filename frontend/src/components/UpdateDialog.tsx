        ...
        <div className="space-y-4 py-4">
          {!isDownloading && !error && (
            <>
              ...
              {updateInfo.body && (
                <div className="bg-secondary/5 border border-border/10 rounded-lg p-3 max-h-40 overflow-y-auto">
        ...
        <DialogFooter>
          {!isDownloading && !error && (
            <>
              ...
              <Button onClick={handleDownloadAndInstall} className="bg-primary text-background hover:bg-primary/90">
